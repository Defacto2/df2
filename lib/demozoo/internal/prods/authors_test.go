...
func TestProductionsAPIv1_Authors(t *testing.T) {
	tests := []struct {
		...
		{"record 1", example1, prods.Authors{nil, []string{"Ile"}, []string{"Ile"}, nil}},
		{"record 2", example2, prods.Authors{nil, []string{"Deep Freeze"}, []string{"The Cardinal"}, nil}},
		{"nick is_group", example3, prods.Authors{nil, nil, nil, nil}},
	}
